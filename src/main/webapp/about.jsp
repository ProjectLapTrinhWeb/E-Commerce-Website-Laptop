...
<html lang="en">
<head>
    <title>About | Laptop Store</title>
    <!-- for-mobile-apps -->
    ...
    <div class="container">
        <div class="w3ls_about_grids">
            <div class="col-md-6 w3ls_about_grid_left">
                <p>Nhóm sinh viên k44 Khoa Công nghệ thông tin Trường Đại học Nông Lâm 2020 với 3 thành viên là Vũ Trương Quang Hào, Nguyễn Cao Hoàng và Huỳnh Ái Quốc. </p>
                <div class="col-xs-2 w3ls_about_grid_left1">
                    <span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>
                </div>
                <div class="col-xs-10 w3ls_about_grid_left2">
                    <p>Ta là những người trẻ trong thân xác già nua <br>
                        Hát những câu hát vì đượm mồ hôi mà chua<br>
                        Không phải là chim câu nên muốn tung cánh vì:<br>
                        - Tự do không đến từ những vụn bánh mì!</p>
                </div>
                ...
                <div class="col-xs-10 w3ls_about_grid_left2">
                    <p>Không bao giờ chùn bước ta sẽ tỏa sáng vào mai đây <br>
                        Nỗ lực qua từng ngày, dù chẳng có một ai hay <br>
                        Họ nói rằng ta yếu đuối ta chứng minh họ sai ngay <br>
                        Còn những người định cản bước, get out of my way!!!
                    </p>
                </div>
                <div class="clearfix"> </div>
            </div>
            <div class="col-md-6 w3ls_about_grid_right" style="padding-left: 50px; border-left: 5px solid #0064cf;">
                <img src="images/team-about.jpg" alt=" " style="width: 600px; height: 400px;" class="img-responsive" />
            </div>
            <div class="clearfix"> </div>
        </div>
    </div>
...
<div class="team">
    <div class="container">
        <h3>Meet Our Team</h3>
        <div class="wthree_team_grids our-team">
            <div class="wthree_team_grid">
                <img src="images/hao.jpg" alt=" " class="img-responsive" />
                <h4>Vũ Trương Quang Hào<span>18130073</span></h4>
                <div class="agileits_social_button">
                    <ul>
                        <li><a href="https://www.facebook.com/vutruongquanghao/" class="facebook" target="_blank"> </a></li>
            ...
            <div class="wthree_team_grid">
                ...
                <h4>Nguyễn Cao Hoàng<span>18130083</span></h4>
                <div class="agileits_social_button">
                    <ul>
            ...
            <div class="wthree_team_grid">
                ...
                <h4>Huỳnh Ái Quốc<span>18130000</span></h4>
                <div class="agileits_social_button">
                    <ul>
                        <li><a href="#" class="facebook"> </a></li>
                        <li><a href="#" class="twitter"> </a></li>
