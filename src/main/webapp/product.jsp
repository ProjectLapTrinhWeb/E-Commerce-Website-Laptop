                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                    ...
                                    <div class="panel-body panel_text">
                                        <ul>
                                            ...
                                            <li><a href="LaptopOffice">Laptop Office</a></li>
                                            <li><a href="LaptopGraphic">Laptop Graphic</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="w3ls_mobiles_grid_left_grid">
                    ...
                    <div class="w3ls_mobiles_grid_left_grid_sub">
                        <div class="ecommerce_color ecommerce_size">
                            <ul>
                                <li><a href="Laptop5To10MA">5.000.000 - 10.000.000 triệu</a></li>
                                <li><a href="Laptop10To20MA">10.000.000 - 20.000.000 triệu</a></li>
                                <li><a href="Laptop20To30MA">20.000.000 - 30.000.000 triệu</a></li>
                                <li><a href="Laptop30To40MA">30.000.000 - 40.000.000 triệu</a></li>
                                <li><a href="Laptop40To50MA">40.000.000 - 50.000.000 triệu</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="w3ls_mobiles_grid_right_grid3">
                    ...
                    <div class="col-md-4 agile_ecommerce_tab_left">
                        ...
                        <div class="simpleCart_shelfItem">
                            <p><span><%= s.getVNDPrice()%></span><br><i class="item_price"><%= s.getPriceSale()%>
                            </i></p>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-7 modal_body_right">
                                            ...
                                            <div class="modal_body_right_cart simpleCart_shelfItem">
                                                <p><span><%= s.getVNDPrice()%></span> <i
                                                        class="item_price"><%= s.getPriceSale()%>
                                                </i></p>
                                                <form action="#" method="post">
                                                    <input type="hidden" name="cmd" value="_cart"/>
                                                    <input type="hidden" name="id" value="<%= s.getId()%>"/>
